package toby.learningtest.spring.pointcut;
...
public class PointcutExpressionTest {
	...
	public void methodSignaturePointcut() throws SecurityException, NoSuchMethodException {
		...
		/*pointcut.setExpression("execution(public int "
				+ "toby.learningtest.spring.pointcut.Target.minus(int,int) "
	...
	public void pointcut() throws Exception {
		...
		tagetClassPointcutMatches("execution(* toby.learningtest.spring.pointcut.Target.*(..))", true, true, true, true, true, false);
		tagetClassPointcutMatches("execution(* toby.learningtest.spring.pointcut.*.*(..))", true, true, true, true, true, true);
		tagetClassPointcutMatches("execution(* toby.learningtest.spring.pointcut..*.*(..))", true, true, true, true, true, true);
		tagetClassPointcutMatches("execution(* toby..*.*(..))", true, true, true, true, true, true);
